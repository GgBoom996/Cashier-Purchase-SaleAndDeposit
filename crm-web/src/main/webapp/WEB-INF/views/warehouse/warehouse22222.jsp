...
<head>
   ...
   <%@include file="/static/common/common_header.jsp"%>
    <script src="/static/js/model/warehouse/warehouse.js"></script>
</head>
<body>
<%--datagrid--%>
...
<%--添加或者编辑的dialog--%>
<div id="warehouseDlg" class="easyui-dialog" style="width: 400px"
     closed="true" buttons="#dlg-buttons">
    <form id="warehouseForm" method="post" novalidate style="margin:0;padding:20px 50px">
        <%--编辑隐藏域的处理--%>
