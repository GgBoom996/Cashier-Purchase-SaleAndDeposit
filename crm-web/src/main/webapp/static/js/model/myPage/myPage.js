var pan = new Vue({
    ...
    methods: {
        ...
        handleDelete(row, column, event) {
            ...
            this.delete('/myPage/remove', params);
        },
        ...
        saveServer() {
            ...
            let params = {
                ...
                shopName: this.messageForm.shopName,
                shopkeepersName: this.messageForm.shopkeepersName,
                wechatAccount: this.messageForm.wechatAccount,
                industryType: this.messageForm.industryType,
                shopAbbreviation: this.messageForm.shopAbbreviation,
                shopPhone: this.messageForm.shopPhone,
                registrationTime: this.messageForm.registrationTime,
                shopAddress: this.messageForm.shopAddress,
            };
            this.$refs['messageForm'].validate((valid) => {
                if (valid) {
                    ...
                    if (this.messageForm.id) {
                        ...
                        this.save('/myPage/saveUpdate', s, 'messageVisible');
                    } else {
