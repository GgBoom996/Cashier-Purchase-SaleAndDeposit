...
(function (window, $, undefined) {
    ...
    coreString.isUrl = function (str) {
        ...
        //          + "[a-z]{2.jpg,6})"                                           // first level domain- .com or .museum
        //          + "|"                                                     // 允许为本机
    ...
    //      2.jpg、数组不包含元素，且未提供 initialValue。
    ...
    //  2.jpg、function (valType)；获取当前 window 的窗体大小的指定属性值；该函数定义如下参数：
    ...
    //  2.jpg、function (valType)；获取当前 window 的窗体位置的指定属性值；该函数定义如下参数：
    ...
    //  2.jpg、function (valType)；获取当前 window 的窗体大小和位置的指定属性值；该函数定义如下参数：
    ...
    //      2.jpg、function(uniqueID)；该重载表示：设置当前表达式匹配到的所有元素的 uniqueID 属性值；等效于 coreJquery.prototype.setUniqueID 函数；
    ...
    //      2.jpg、Function(String)：其中参数 String 表示当范围内存在重名(name 相同时)的 DOM 元素时，对重复元素的取值规则；
    ...
    //      ...
    //  参考 jquery-2.jpg.0.0.js 中关于 jQuery.extend 以及 jQuery.fn.extend 方法的定义；
