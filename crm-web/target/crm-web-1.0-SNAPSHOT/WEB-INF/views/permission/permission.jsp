                                    ...
                                    <template>
                                        <div id="asd">
                                            <el-table ref="multipleTable" :data="tableData" border style="width: 100%"
                                                ...
                                                <el-table-column prop="url" label="路径" show-overflow-tooltip></el-table-column>
                                                <el-table-column prop="descs" label="备注" show-overflow-tooltip></el-table-column>
                                                <el-table-column prop="sn" label="角色编号" width="270"></el-table-column>
        ...
        <el-dialog  :visible.sync="messageVisible" width="33%" center
            ...
            <el-form :model="messageForm" :label-width="messageLabelWidth" ref="messageForm"
                ...
                <el-form-item label="路径" prop="url">
                    <el-input v-model="messageForm.url" placeholder="请输入路径"></el-input>
                </el-form-item>
                <el-form-item label="备注" prop="descs">
                    <el-input v-model="messageForm.descs" placeholder="请输入备注"></el-input>
                </el-form-item>
